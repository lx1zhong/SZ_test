...
No = {'bump_dense':0, 'eddy_velx_f4':1, 'EXAALT':2, 'CESM_ATM':3, 'Hurricane':4, 'Miranda':5, 'EXASKY_NYX':6, 'QMCPack':7, 'EXAALT_HELIUM':8, }
# filter = dataset_names

# eb range to show
bottom = [3,1,1,2,1,3,1,1,1]
top    = [8,6,6,7,6,8,6,6,6]
...
for input_file in input_files:
    ...
    for dataset in filter:
        ...
        c0=plt.bar(x-width,stat[CTIME_PART][dataset][HUFFMAN].values(),width=width-0.01,label='Huffman',lw=0.02,edgecolor='Black',color='#DCDCDC',zorder=2)
        matplotlib.rcParams['hatch.linewidth']=0.04
        c1=plt.bar(x,stat[CTIME_PART][dataset][ZSTD].values(),width=width-0.01,label='Zstd',lw=0.01,edgecolor='black',color='#87CEFA',zorder=2)
        c2=plt.bar(x+width,stat[CTIME_PART][dataset][FSE].values(),width=width-0.01,label='ADT-FSE',lw=0.01,edgecolor='black',color='#ff9912',zorder=2)
    ...
    for dataset in filter:
        ...
        plt.grid(linestyle=':', color="gray",axis='y',zorder=1)
        c0=plt.bar(x-width,stat[DTIME_PART][dataset][HUFFMAN].values(),width=width-0.01,label='Huffman',lw=0.02,edgecolor='Black',color='#DCDCDC',zorder=2)
        # matplotlib.rcParams['hatch.color']=colors[0]
        matplotlib.rcParams['hatch.linewidth']=0.04
        c1=plt.bar(x,stat[DTIME_PART][dataset][ZSTD].values(),width=width-0.01,label='Zstd',lw=0.01,edgecolor='black',color='#87CEFA',zorder=2)
        c2=plt.bar(x+width,stat[DTIME_PART][dataset][FSE].values(),width=width-0.01,label='ADT-FSE',lw=0.01,edgecolor='black',color='#ff9912',zorder=2)
